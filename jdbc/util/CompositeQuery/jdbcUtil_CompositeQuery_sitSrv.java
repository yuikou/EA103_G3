...
public class jdbcUtil_CompositeQuery_sitSrv {
	...
	public static String get_aCondition_For_Oracle(String columnName, String value) {
		...
		if ("addBathing".equals(columnName) || "addPickup".equals(columnName) || "careLevel".equals(columnName) || "stayLoc".equals(columnName)) // 用於其他
			...
			aCondition = " and " + columnName + " <= " + value;
		else if ("nearAddr".equals(columnName)) {// 用於varchar
			if (columnName!=null) {
				int city_index = value.indexOf("市");
				int county_index = value.indexOf("縣");
				if (city_index != -1) {
