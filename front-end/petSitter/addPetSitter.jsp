...
<title>申請保母 - addPetsitter.jsp</title>
...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/css-ching/addPetSitter.css">
    ...
    <div class="container-login100 cover">
        <div class="wrap-login100 mybody">
		    <form method="post" action="<%=request.getContextPath()%>/petSitter/petSitter.do" name="form1" class="login100-form validate-form p-l-55 p-r-55 p-t-70">
  			    <span class="login100-form-title"> Become A PetSitter</span>
					<div class="addBox">
						...
						<div class="wrap-input100 validate-input" data-validate="請輸入銀行代碼">
							<input class="input100" type="text" name="bankCode" size="2"
								value="<%=(petSitterVO == null) ? "" : petSitterVO.getBankCode()%>" /><span
								class="focus-input100"></span>
						</div>
						<div class="info txt1 myP">匯款帳號</div>
						<div class="wrap-input100 validate-input" data-validate="請輸入匯款帳號">
							<input class="input100" type="text" name="bankAcc" size="20"
								value="<%=(petSitterVO == null) ? "" : petSitterVO.getBankAcc()%>">
						...
						<div class="wrap-input100 validate-input" data-validate="請可服務開始時間">
							<select class="select_input input100" size="1" name="srvSTime">
								<option value="${petSitterVO.srvSTime}"><%=(petSitterVO == null) ? "請選擇" : petSitterVO.getSrvSTime()%>
								</option>
						...
						<div class="wrap-input100 validate-input m-b-16"
							data-validate="請輸入托養簡介">
							<textarea name="sitInfo" id="content" rows="10" cols="70"><%=(petSitterVO == null) ? "寫下自己的介紹以及對毛小孩的熱愛" : petSitterVO.getSitInfo()%></textarea>
							<span class="focus-input100"></span>
						</div>
						<div class="p-t-13 p-b-23" id="myTerm">
					        <span class="txt1"> 註冊即同意PETfect Match的 </span>
							<a href="#" class="txt2"> 服務條款 </a>
							<span class="txt1">&</span>
							<a href="#" class="txt2"> 隱私權條款 </a>
						</div>
						<div class="container-login100-form-btn p-b-40">
							<input type="hidden" name="action" value="insert">
							<input class="login100-form-btn input100" id="send" type="submit" value="申請保母">
						</div>
					</div>
				</form>
			</div>
