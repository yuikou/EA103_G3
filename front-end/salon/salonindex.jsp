...
<link href="<%=request.getContextPath()%>/css/Dave/styles.css" rel="stylesheet" />
</head>
<body id="page-top">
<%@ include file="/salonHeader.jsp"%>
	...
	<!-- Navigation-->
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary2 fixed-top2"
		id="sideNav">
		<a class="navbar-brand js-scroll-trigger" href="#page-top"> <span
			class="d-block d-lg-none">${salonVO.salName}</span> <span
			class="d-none d-lg-block">
			<img
				class="img-fluid img-profile rounded-circle mx-auto mb-2"
				src="${pageContext.request.contextPath}/front-end/salon/ShowPic.do?action=salPic&salNo=${salonVO.salNo}" alt="" /></span>
		</a>
	...
	<div class="container-fluid p-0">
		...
		<section class="resume-section" id="about">
			<div class="resume-section-content">
				<h1 class="mb-0">
					${salonVO.salName} <span class="text-primary2">${salonVO.salOwner}</span>
				</h1>
				<div class="subheading mb-5">
					${salonVO.salCity} ${salonVO.salDist} ${salonVO.salAdr} 
					<a id= "mailtext" href="mailto:name@email.com">${salonVO.salMail}</a>
				</div>
				<div class="subheading mb-5">電話:${salonVO.salPh}</div>
				<p class="lead mb-5">
				<H5>Info:</H5>${salonVO.salInfo}</p>
	...
	<!-- Core theme JS-->
	<script src="<%=request.getContextPath()%>/js/Dave/scripts.js"></script>
