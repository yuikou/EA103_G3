...
//		"SELECT 1 FROM MEMBER_TABLE WHERE memId=?";
			...
			throw new RuntimeException("Couldn't load driver error. " + e.getMessage());
...
//		memVO1.setMemBirth(new java.sql.Date(System.currentTimeMillis()-100000));
//		memVO1.setMemId("aaaaaa1");
//		memVO1.setMemPsw("123456");
//		memVO1.setMemAddress("台北市");
//		memVO1.setMemEmail("aaa@bbbmail.com");
//		memVO1.setMemPhone("08-45612378");
//		byte[] pic = getPictureByteArray("WebContent/member/image/memphoto.jpeg");
//		memVO1.setMemPhoto(pic);
//		dao.insert(memVO1);
